...
def agent(
    ...
    agent_loop = AgentLoop(
        ...
        context_window_override=config.agents.defaults.context_window,
        background_context_window_override=config.agents.defaults.background_context_window,
        emergency_trim_threshold=config.agents.defaults.emergency_trim_threshold,
